...
data %>% 
  tally_and_perc(Gender, na.rm = FALSE)
...
# but lets put it in a new col so we stil have the orignal values
# available. 
#
# Also, let's use the forcats pkg to to handle factors because it works
# well with dplyr
#
